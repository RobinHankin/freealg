---
title: "Internal consistency of the `freealg` package using matrix algebra"
...
@hankin2022_freealg.  In this short document I give some numerical
evidence that the `freealg` package is internally consistent.
