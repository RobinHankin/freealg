...
Here we verify that the `freealg` package is consistent.  We will
evaluate an expression on three indeterminates, `A,B,C`, here random
matrices:
...
`sed`.  Cut-and-paste the above output into a file called `e.txt` and
...
is within numerical tolerances.