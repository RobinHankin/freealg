...
Special dispensation is made if the arguments are matrices.  This is
because in standard R idiom, `A*B` refers to Hadamard (elementwise)
multiplication, which is an abomination; with this definition the Lie
bracket is identically zero.  The package therefore includes a matrix
method:
