...
The ```freealg``` package provides some functionality for fast the
free algebra, using the Standard Template library of ```C++```,
...
Scalar multiplication is usually denoted by juxtaposition and
satisfies, for any $a,b\in\mathbb{F}$ and
